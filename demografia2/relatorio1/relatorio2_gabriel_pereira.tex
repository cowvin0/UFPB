...
\caption{}\label{T_590e6}\tabularnewline
\toprule\noalign{}
...
\caption{}\label{T_8d733}\tabularnewline
\toprule\noalign{}
...
\caption{}\label{T_b15b8}\tabularnewline
\toprule\noalign{}
...
\caption{}\label{T_5e4ba}\tabularnewline
\toprule\noalign{}
...
\begin{longtable}[]{@{}lllllll@{}}
\caption{}\label{T_78cbd}\tabularnewline
\toprule\noalign{}
...
\begin{longtable}[]{@{}lllllll@{}}
\caption{}\label{T_e73c3}\tabularnewline
\toprule\noalign{}
...
\begin{longtable}[]{@{}lllllll@{}}
\caption{}\label{T_e5195}\tabularnewline
\toprule\noalign{}
...
\begin{longtable}[]{@{}lllllll@{}}
\caption{}\label{T_d9e84}\tabularnewline
\toprule\noalign{}
Idade & I(x) & I(x) GB & Ys(x) & Y(x) & Y(x) estimado GB & I(x) estimado
GB \\
\midrule\noalign{}
...
\begin{longtable}[]{@{}lllllll@{}}
\caption{}\label{T_e5247}\tabularnewline
\toprule\noalign{}
Idade & I(x) & I(x) MAB & Ys(x) & Y(x) & Y(x) estimado MAB & I(x)
estimado MAB \\
\midrule\noalign{}
