...
\caption{}\label{T_38adf}\tabularnewline
\toprule\noalign{}
...
\caption{}\label{T_94edc}\tabularnewline
\toprule\noalign{}
...
\caption{}\label{T_3fd49}\tabularnewline
\toprule\noalign{}
...
\caption{}\label{T_c4fc0}\tabularnewline
\toprule\noalign{}
...
\begin{longtable}[]{@{}lllllll@{}}
\caption{}\label{T_0abed}\tabularnewline
\toprule\noalign{}
...
\begin{longtable}[]{@{}lllllll@{}}
\caption{}\label{T_7e0f7}\tabularnewline
\toprule\noalign{}
...
\begin{longtable}[]{@{}lllllll@{}}
\caption{}\label{T_15c2b}\tabularnewline
\toprule\noalign{}
...
\begin{longtable}[]{@{}lllllll@{}}
\caption{}\label{T_5777b}\tabularnewline
\toprule\noalign{}
Idade & I(x) & I(x) GB & Ys(x) & Y(x) & Y(x) estimado GB & I(x) estimado
GB \\
\midrule\noalign{}
...
\begin{longtable}[]{@{}lllllll@{}}
\caption{}\label{T_b129c}\tabularnewline
\toprule\noalign{}
Idade & I(x) & I(x) MAB & Ys(x) & Y(x) & Y(x) estimado MAB & I(x)
estimado MAB \\
\midrule\noalign{}
