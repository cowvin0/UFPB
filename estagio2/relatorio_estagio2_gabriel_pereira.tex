...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, breakable, sharp corners, enhanced, colback={codebgcolor}, frame hidden]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
