...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, breakable, enhanced, boxrule=0pt, colback={codebgcolor}, frame hidden]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
