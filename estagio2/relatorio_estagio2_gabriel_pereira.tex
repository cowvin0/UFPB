...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, sharp corners, colback={codebgcolor}, boxrule=0pt, frame hidden, enhanced]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
...
\textbf{(FALAR SOBRE PARA QUE FOI O ESTÁGIO E FALAR BREVEMENTE SOBRE A
EMPRESA)}
...
partir do \textbf{Denodo}, foram coletadas 29 séries temporais
...
total, essas cooperativas reúnem mais de 300 agências.
