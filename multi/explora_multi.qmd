...
As variáveis têm uma correlação significativa entre si, sendo o comprimento da concha e o diâmetro as mais correlacionadas. Além disso, perceba que a relação entre elas é diretamente proporcional, o que faz sentido, uma vez que se trata de medidas corporais dos moluscos.
