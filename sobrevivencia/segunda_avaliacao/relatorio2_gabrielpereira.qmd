...
Ajuste o modelo de Cox aos dados. Interprete os coeficientes do modelo escolhido. Quais critérios você considerou para obter os modelos?
...
```{r eval=FALSE}
df <- read_delim("sobrevivencia/segunda_avaliacao/includes/dialcompete.txt", delim = " ") |>
  mutate(
    intervalo = cut(
      tempo,
      breaks = 1:44,
